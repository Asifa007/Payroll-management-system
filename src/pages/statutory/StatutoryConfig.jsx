...
export default function StatutoryConfig() {
    ...
    return (
        <div className="page-container">
            ...
            {/* Provident Fund */}
            <SectionCard title="Provident Fund (PF)" icon={Shield} color="#2563eb">
            ...
            {/* ESI */}
            <SectionCard title="Employee State Insurance (ESI)" icon={Shield} color="#7c3aed">
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 16 }}>
            ...
            {/* Professional Tax */}
            <SectionCard title="Professional Tax (PT)" icon={Shield} color="#0891b2">
            ...
            {/* TDS */}
            <SectionCard title="TDS / Income Tax" icon={Shield} color="#d97706">
            ...
            {/* Gratuity */}
            <SectionCard title="Gratuity" icon={Shield} color="#16a34a">
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 16 }}>
            ...
            {/* LWF */}
            <SectionCard title="Labour Welfare Fund (LWF)" icon={Shield} color="#dc2626">
                <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap', alignItems: 'flex-start' }}>
