...
const INITIAL_EMPLOYEES = [
    { id: 'EMP001', name: 'Arjun Kumar', email: 'arjun@acme.com', phone: '9876543210', dept: 'Engineering', designation: 'Senior Engineer', type: 'Full-Time', ctc: 1800000, status: 'Active', doj: '2023-01-15', gender: 'Male' },
    { id: 'EMP002', name: 'Priya Nair', email: 'priya@acme.com', phone: '9876543211', dept: 'HR', designation: 'HR Manager', type: 'Full-Time', ctc: 900000, status: 'Active', doj: '2022-03-01', gender: 'Female' },
    { id: 'EMP003', name: 'Rahul Verma', email: 'rahul@acme.com', phone: '9876543212', dept: 'Sales', designation: 'Sales Executive', type: 'Full-Time', ctc: 720000, status: 'Active', doj: '2023-06-12', gender: 'Male' },
    { id: 'EMP004', name: 'Sneha Reddy', email: 'sneha@acme.com', phone: '9876543213', dept: 'Finance', designation: 'Finance Analyst', type: 'Full-Time', ctc: 840000, status: 'Inactive', doj: '2021-11-20', gender: 'Female' },
    { id: 'EMP005', name: 'Vikram Patel', email: 'vikram@acme.com', phone: '9876543214', dept: 'Engineering', designation: 'DevOps Engineer', type: 'Full-Time', ctc: 1500000, status: 'Active', doj: '2022-08-01', gender: 'Male' },
    { id: 'EMP006', name: 'Anita Sharma', email: 'anita@acme.com', phone: '9876543215', dept: 'Marketing', designation: 'Marketing Lead', type: 'Full-Time', ctc: 960000, status: 'Active', doj: '2023-03-05', gender: 'Female' },
    { id: 'EMP007', name: 'Ravi Krishnan', email: 'ravi@acme.com', phone: '9876543216', dept: 'Engineering', designation: 'Tech Lead', type: 'Full-Time', ctc: 2200000, status: 'Active', doj: '2020-07-15', gender: 'Male' },
    { id: 'EMP008', name: 'Kavita Singh', email: 'kavita@acme.com', phone: '9876543217', dept: 'Operations', designation: 'Operations Manager', type: 'Full-Time', ctc: 780000, status: 'Active', doj: '2021-05-10', gender: 'Female' },
];
...
export default function EmployeeList() {
    ...
    const onSubmit = async (data) => {
        ...
        setSaving(false);
        if (modal === 'add') {
            const newEmp = { ...data, id: `EMP${String(employees.length + 1).padStart(3, '0')}` };
            setEmployees((prev) => [...prev, newEmp]);
            toast.success('Employee added successfully!');
        } else if (modal?.type === 'edit') {
            setEmployees((prev) => prev.map((e) => e.id === modal.emp.id ? { ...e, ...data } : e));
