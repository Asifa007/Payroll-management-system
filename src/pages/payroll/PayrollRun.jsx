...
const PAYROLL_HISTORY = [
    { month: 'Feb 2026', employees: 156, gross: 3150000, deductions: 425000, net: 2725000, status: 'Paid', runDate: '28 Feb 2026' },
    { month: 'Jan 2026', employees: 153, gross: 3080000, deductions: 418000, net: 2662000, status: 'Paid', runDate: '31 Jan 2026' },
    { month: 'Dec 2025', employees: 150, gross: 3100000, deductions: 420000, net: 2680000, status: 'Paid', runDate: '31 Dec 2025' },
];
...
const PREVIEW_DATA = [
    { id: 'EMP001', name: 'Arjun Kumar', dept: 'Engineering', gross: 145000, pf: 7500, esi: 0, pt: 200, tds: 12000, net: 125300 },
    { id: 'EMP002', name: 'Priya Nair', dept: 'HR', gross: 72000, pf: 4500, esi: 540, pt: 200, tds: 3500, net: 63260 },
    { id: 'EMP003', name: 'Rahul Verma', dept: 'Sales', gross: 55000, pf: 3600, esi: 413, pt: 200, tds: 1500, net: 49287 },
    { id: 'EMP004', name: 'Sneha Reddy', dept: 'Finance', gross: 67000, pf: 4200, esi: 503, pt: 200, tds: 2800, net: 59297 },
    { id: 'EMP005', name: 'Vikram Patel', dept: 'Engineering', gross: 132000, pf: 7500, esi: 0, pt: 200, tds: 9500, net: 114800 },
];
...
export default function PayrollRun() {
    ...
    const totalGross = PREVIEW_DATA.reduce((s, e) => s + e.gross, 0);
    const totalNet = PREVIEW_DATA.reduce((s, e) => s + e.net, 0);
    const totalDed = PREVIEW_DATA.reduce((s, e) => s + e.pf + e.esi + e.pt + e.tds, 0);
                    ...
                    {(stage !== 'ready' && stage !== 'processing') && (
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 12, marginBottom: 14 }}>
                            {[
                                ...
                                { label: 'Total Deductions', val: fmtL(totalDed * 31), color: '#dc2626', bg: '#fef2f2' },
                    ...
                    <table className="data-table">
                        ...
                        <tbody>
                            ...
                            <tr style={{ background: '#f8fafc', fontWeight: 700 }}>
                                ...
                                <td>{fmtINR(PREVIEW_DATA.reduce((s, e) => s + e.pf, 0))}</td>
                                <td>{fmtINR(PREVIEW_DATA.reduce((s, e) => s + e.esi, 0))}</td>
                                <td>{fmtINR(PREVIEW_DATA.reduce((s, e) => s + e.pt, 0))}</td>
                                <td>{fmtINR(PREVIEW_DATA.reduce((s, e) => s + e.tds, 0))}</td>
