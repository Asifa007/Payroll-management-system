...
const MOCK_NOTIFICATIONS = [
    { id: 1, text: 'March payroll run completed', time: '2 min ago', unread: true },
    { id: 2, text: '3 employees pending approval', time: '1 hr ago', unread: true },
    { id: 3, text: 'ESI filing due in 5 days', time: '3 hr ago', unread: false },
    { id: 4, text: 'New employee added: Arjun Kumar', time: '1 day ago', unread: false },
];
                    ...
                    {showNotif && (
                        <div style={{
                            ...
                            <div style={{ padding: '14px 16px', borderBottom: '1px solid #e2e8f0', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                ...
                                <span style={{ fontSize: 12, color: '#2563eb', cursor: 'pointer', fontWeight: 600 }}>Mark all read</span>
                            </div>
                            {MOCK_NOTIFICATIONS.map((n) => (
                                <div key={n.id} style={{
                                    ...
                                    <div style={{
                                        ...
                                        <Bell size={13} color={n.unread ? '#2563eb' : '#94a3b8'} />
                                    </div>
                                    <div>
                                        <p style={{ fontSize: 12.5, color: '#334155', fontWeight: n.unread ? 600 : 400 }}>{n.text}</p>
                ...
                <div style={{ position: 'relative', marginLeft: 4 }}>
                    ...
                    {showProfile && (
                        <div style={{
                            ...
                            {[
                                { label: 'My Profile', icon: UserCircle, action: () => navigate('/ess') },
