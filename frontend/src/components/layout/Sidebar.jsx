...
import {
    ...
    Receipt, AlertCircle, BookOpen, Landmark, UserCheck,
} from 'lucide-react';
...
const NAV_ITEMS = [
    ...
    },
    {
        ...
        items: [
            { label: 'Employee Self Service', path: '/ess', icon: UserCheck, module: 'ess' },
        ],
    },
    {
...
export default function Sidebar({ collapsed, onToggle }) {
    ...
    const roleColor = {
        ...
        [ROLES.PAYROLL_ADMIN]: '#60a5fa',
        [ROLES.HR_ADMIN]: '#34d399',
        [ROLES.FINANCE]: '#fbbf24',
        [ROLES.EMPLOYEE]: '#f87171',
    }[user?.role] || '#94a3b8';
